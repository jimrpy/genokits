...
fgenome_download <- function(genome_id = "ON400500.1") {
  ...
  df <- lapply(xml2::xml_children(xml), function(z) {
    ...
    isolate <- xml_helper(z, './/GBQualifier[GBQualifier_name = "isolate"]/GBQualifier_value')
    ...
    location <- xml_helper(z, './/GBQualifier[GBQualifier_name = "geo_loc_name"]/GBQualifier_value')
